...
def dyn_dns_client() -> None:
    ...
    app_config = Config()
    public_ip_provider = publicip.MyPublicIP()
    dyn_dns_client = dyndnsclient.DynDnsClient(dyn_dns_api_url=app_config.api_url, dns_name=app_config.dns_domain, dns_cache_ttl_sec=app_config.dns_record_ttl_sec)
